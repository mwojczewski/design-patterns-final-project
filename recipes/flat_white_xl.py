...
class FlatWhiteXL(Recipe):

    def __init__(self) -> None:
        self.__cup = Cup(400)

    def __str__(self) -> str:
        return f'Flat White XL'

    def add_base_component(self) -> None:
        grounded_coffee = Grinder(RoastedCoffee(26.0)).grind()
    ...
    def add_second_component(self) -> None:
        milk = Frother(RegularMilk(40.0)).pass_milk(RegularMilk())
        self.__cup.add_ingredient(milk)

    def add_top_component(self) -> None:
        milk = Frother(RegularMilk(200.0)).pass_milk(FrothedMilk())
        self.__cup.add_ingredient(milk)
